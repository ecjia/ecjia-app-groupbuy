	      	...
	      	<section class="panel">
	      		<div class="panel-body">
					...
					<div class="form-group" >
						...
						<div class="col-lg-6">
							<input class="form-control" type="text" name="restrict_amount" id="restrict_amount" value="{$group_buy.restrict_amount|default:0}" {if $group_buy.status neq 0}disabled{/if}/>
